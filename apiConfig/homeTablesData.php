...
try {
  ...
  if ($input["tablename"] === "bookings") {
    ...
    $response["message"] = "Data retrieved successful";
    $response["data"] = $result;
    echo json_encode($response);
  } else if ($input["tablename"] === "theaters") {
    ...
    $response["data"] = $result;
    echo json_encode($response);
  } else if ($input["tablename"] === "movies") {
